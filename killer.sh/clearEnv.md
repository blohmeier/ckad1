...
```bash
rm /opt/course/1/namespaces
cat /opt/course/1/namespaces #cat: /opt/course/1/namespaces: No such file or directory
```
</p>
</details>
...
```bash
rm /opt/course/2/pod1-status-command.sh
cat /opt/course/2/pod1-status-command.sh #cat: /opt/course/2/pod1-status-command.sh: No such file or directory
k delete pod pod1
k get pod | grep pod1 #no result
```
</p>
</details>
